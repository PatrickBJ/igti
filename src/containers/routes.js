...
import TrabalhoModulo3 from '../components/TrabalhoModulo3/TrabalhoModulo3';
import DesafioModulo3 from '../components/DesafioModulo3/DesafioModulo3'
...
const listaPaginas = [
    ...
    {
      rota: 'DesafioModulo3',
      nome: 'Desafio Modulo3',
      icone: <MoneyOff/>,
      component: DesafioModulo3
  }
  ];
...
{  
    ...
    <Switch>
        ...
        <Route path="/DesafioModulo3" exact={true} component={DesafioModulo3} />
